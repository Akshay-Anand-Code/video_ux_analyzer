...
Build an AI-powered tool that analyzes product demo videos and identifies UX issues. Users upload a product demo video, and the system analyzes it to deatect usability problems, interaction issues, and areas for improvement.
...
3. Includde a `NOTES.md` file with:
   - high level esign
   - any instructions to run
   - what issues you forsee which needs to be taken care of in the productionised version of the tool
4. **Record a Loom** walking through the working tool — upload a demo video, show the analysis results, and narrate what's happening
